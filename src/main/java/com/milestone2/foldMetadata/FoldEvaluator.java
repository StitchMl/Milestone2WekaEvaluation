...
public class FoldEvaluator {
 ...
 FoldEvaluator(PositiveClassResolver positiveClassResolver,
 ...
 */
 public FoldResult evaluate(Definition definition,
 RunConfig config,
 ...
 Classifier baseClassifier = ClassifierFactory.createClassifier(
 definition,
